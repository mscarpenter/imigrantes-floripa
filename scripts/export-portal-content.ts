...
function formatFaqAndPages(): string {
  const lines = [
    ...
    "",
    `#### ${ptDict.about.openSourceTitle}`,
    "",
    `${ptDict.about.openSource} ${ptDict.about.openSourceLink}`,
    "",
    `#### ${ptDict.about.disclaimerTitle}`,
    "",
    `${ptDict.about.disclaimerBeforeContact}${ptDict.about.disclaimerContactLink}${ptDict.about.disclaimerAfterContact}`,
    "",
    "---",
    "",
    `### ${ptDict.faq.title}`,
